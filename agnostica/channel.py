...
from .utils import MISSING, Object
...
class CalendarChannel(agnostica.abc.ServerChannel):
...
class CalendarEvent(Hashable, HasContentMixin):
    ...
    def __init__(self, *, state, data: CalendarEventPayload, channel: CalendarChannel):
        ...
        self.starts_at: datetime.datetime = data.get('startsAt')
    ...
    async def fetch_rsvp(self, user: agnostica.abc.User, /) -> CalendarEventRSVP:
        """|coro|
...
class ChatChannel(agnostica.abc.ServerChannel, agnostica.abc.Messageable):
...
class DocsChannel(agnostica.abc.ServerChannel):
...
class ForumTopic(Hashable, HasContentMixin):
    ...
    def __init__(self, *, state, data: ForumTopicPayload, channel: ForumChannel):
        ...
        self.created_at: datetime.datetime = data.get('createdAt')
        self.updated_at: Optional[datetime.datetime] = data.get('updatedAt')
        self.bumped_at: Optional[datetime.datetime] = data.get('bumpedAt')
    ...
    def share_url(self) -> str:
        ...
        if self._platform.get_forum_topic_share_url is not None:
            return self._platform.get_forum_topic_share_url(self)
        return f'{self.channel.share_url}/{self.id}'
    ...
    async def add_reaction(self, emote: Emote, /) -> None:
        ...
        """
        emote_id: int = getattr(emote, 'id', emote)
        await self._platform.add_forum_topic_reaction(self.server.id, self.channel.id, self.id, emote_id)
    ...
    async def remove_self_reaction(self, emote: Emote, /) -> None:
        ...
        """
        emote_id: int = getattr(emote, 'id', emote)
        await self._platform.remove_forum_topic_reaction(self.server.id, self.channel.id, self.id, emote_id)
    ...
    async def edit(
        ...
        *,
        ...
        data = await self._platform.update_forum_topic(
            self,
            payload=payload,
        )
        topic = ForumTopic(state=self._state, _platform=self._platform, data=data, channel=self.channel)
        return topic
    ...
    async def delete(self) -> None:
        ...
        """
        await self._platform.delete_forum_topic(self)
    ...
    async def pin(self) -> None:
        ...
        """
        await self._platform.pin_forum_topic(self)
    ...
    async def unpin(self) -> None:
        ...
        """
        await self._platform.unpin_forum_topic(self)
    ...
    async def lock(self) -> None:
        ...
        """
        await self._platform.lock_forum_topic(self)
    ...
    async def unlock(self) -> None:
        ...
        """
        await self._platform.unlock_forum_topic(self)
    ...
    async def reply(self, content: str) -> ForumTopicReply:
        ...
        data = await self._platform.create_forum_topic_comment(self, content=content)
        return ForumTopicReply(state=self._state, _platform=self._platform, data=data, parent=self)
    ...
    async def fetch_reply(self, reply_id: int, /) -> ForumTopicReply:
        ...
        data = await self._platform.get_forum_topic_comment(self, reply_id)
        return ForumTopicReply(state=self._state, _platform=self._platform, data=data, parent=self)
    ...
    async def fetch_replies(self) -> List[ForumTopicReply]:
        ...
        data = await self._platform.get_forum_topic_comments(self, self.id)
        return [
            ForumTopicReply(state=self._state, _platform=self._platform, data=reply_data, parent=self)
            for reply_data in data
        ]


class ForumChannel(agnostica.abc.ServerChannel):
    ...
    async def create_topic(
        ...
        *,
        ...
        data = await self._platform.create_forum_topic(
            self,
            title=title,
            content=content,
        )

        topic = ForumTopic(data=data, channel=self, state=self._state, _platform=self._platform)
        return topic
    ...
    async def fetch_topic(self, topic_id: int, /) -> ForumTopic:
        ...
        data = await self._platform.get_forum_topic(self, topic_id)
        topic = ForumTopic(data=data, channel=self, state=self._state, _platform=self._platform)
        return topic
    ...
    async def topics(
        ...
        while True:
            ...
            data = await self._platform.get_forum_topics(
                self,
                limit=sublimit,
                before=before,
            )
            ...
            for event_data in data:
                yield ForumTopic(state=self._state, _platform=self._platform, data=event_data, channel=self)


class VoiceChannel(agnostica.abc.ServerChannel, agnostica.abc.Messageable):
    ...
    #    ws_build = VoiceWebSocket.build( loop=self.loop)
    #    gws = await asyncio.wait_for(ws_build, timeout=60)
    #    if type(gws) != VoiceWebSocket:
...
class Thread(agnostica.abc.ServerChannel, agnostica.abc.Messageable):
...
class DMChannel(Hashable, agnostica.abc.Messageable):
    ...
    def __init__(self, *, state, _platform, data: Dict[str, Any]):
    ...
    def share_url(self) -> str:
        ...
        if self._platform.get_dm_channel_share_url is not None:
            return self._platform.get_dm_channel_share_url(self)
        return self._platform.BASE

    @property
    def users(self) -> List[User]:
        """List[:class:`~agnostica.User`]: The list of participants in this DM, including yourself."""
...
class AnnouncementChannel(agnostica.abc.ServerChannel):
...
class Media(Hashable, HasContentMixin):
    ...
    url: :class:`str`
        The media's URL on the platform's CDN.
...
class ListItem(Hashable, HasContentMixin):
    ...
    def __init__(self, *, state, _platform, data: ListItemPayload, channel: ListChannel):
        super().__init__()
        ...
        self.completed_at: Optional[datetime.datetime] = data.get('completedAt')
    ...
    def share_url(self) -> Optional[str]:
        ...
        if self._platform.get_list_item_share_url is not None:
            return self._platform.get_list_item_share_url(self.channel, self.id)
    ...
    async def delete(self) -> None:
        ...
        Delete this item.
        """
        await self._platform.delete_list_item(self.channel.id, self.id)
    ...
    async def edit(
        ...
        *,
        ...
        data = await self._platform.update_list_item(
            self.channel.id,
            self.id,
            payload=payload,
        )
        item = ListItem(data=data, channel=self.channel, state=self._state, _platform=self._platform)
        return item
    ...
    async def complete(self) -> None:
        ...
        """
        await self._platform.complete_list_item(self.channel.id, self.id)
    ...
    async def uncomplete(self) -> None:
        ...
        """
        await self._platform.uncomplete_list_item(self.channel.id, self.id)


class MediaChannel(agnostica.abc.ServerChannel):
...
class ListChannel(agnostica.abc.ServerChannel):
    ...
    async def fetch_item(self, item_id: str, /) -> ListItem:
        ...
        data = await self._platform.get_list_item(self.id, item_id)
        item = ListItem(data=data['listItem'], channel=self, state=self._state, _platform=self._platform)
        return item
    ...
    async def fetch_items(self) -> List[ListItem]:
        ...
        data = await self._platform.get_list_items(self.id)

        items = []
        for item_data in data['listItems']:
            items.append(ListItem(data=item_data, channel=self, state=self._state, _platform=self._platform))
    ...
    async def create_item(
        ...
        *,
        ...
        data = await self._platform.create_list_item(
            self.id,
            message=message,
            note_content=note_content,
        )
...
class Availability(Hashable):
    ...
    def __init__(self, *, state, data, channel: SchedulingChannel):
        ...
        self.id: int = data['id']
        self.start: datetime.datetime = data.get('startDate')
        self.end: datetime.datetime = data.get('endDate')
...
class SchedulingChannel(agnostica.abc.ServerChannel):
...
class StreamChannel(agnostica.abc.ServerChannel, agnostica.abc.Messageable):
...
class PartialMessageable(agnostica.abc.Messageable, Hashable):
    ...
    @property
    def group(self) -> Group:
        """Optional[:class:`~agnostica.Group`]: The group that this partial messageable is in."""
        if self.server:
            return self.server.get_group(self.group_id) or self.channel.group
    ...
    def share_url(self) -> str:
        ...
        if self._platform.get_channel_share_url is not None:
            return self._platform.get_channel_share_url(self)
        return self._platform.BASE
    ...
    def created_at(self) -> datetime.datetime:
        ...
        only their UUID, this will always return the default date provided
        by the adapter.
        """

        return self._platform.DEFAULT_DATE
