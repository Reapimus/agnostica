...
from .errors import HTTPException, Forbidden, NotFound, PlatformServerError
...
class AsyncWebhookAdapter:
    ...
    def get_server_webhook(
        ...
        *,
        ...
        return platform.get_server_webhook(server_id, webhook_id, auth_token=auth_token)
    ...
    def delete_webhook(
        ...
        *,
        ...
        return platform.delete_webhook(server_id, webhook_id, auth_token=auth_token)
    ...
    def update_webhook(
        ...
        *,
        ...
        return platform.update_webhook(server_id, webhook_id, payload, auth_token=auth_token)
    ...
    def execute_webhook(
        ...
        *,
        ...
        return platform.execute_webhook(webhook_id, token, payload=payload, multipart=multipart, files=files)
    ...
    def delete_channel_message(
        ...
        return platform.delete_message(server_id, channel_id, message_id)
    ...
    def get_channel_message(
        ...
        return platform.get_message(server_id, channel_id, message_id)
...
class BaseWebhook:
    ...
    def __init__(
        ...
        _platform: Optional[PlatformAdapter] = None,
    ):
        self.auth_token: Optional[str] = auth_token

        self._state: Union[HTTPClient, _WebhookState] = state or _WebhookState(self, parent=state)
        self._platform: PlatformAdapter = _platform or platform
    ...
    def _update(self, data: WebhookPayload):
        ...
        self._avatar_asset: Optional[Asset] = data.get('avatar')
    ...
    def avatar(self) -> Optional[Asset]:
        ...
        """
        if self._avatar_asset is not None:
            return self._avatar_asset
        return None
    ...
    def default_avatar(self) -> Asset:
        ...
        return self._platform.DEFAULT_AVATAR
...
class Webhook(BaseWebhook):
    ...
    .. code-block:: python3
        ...
        from agnostica import Webhook
        import aiohttp

        async def foo():
            async with aiohttp.ClientSession() as session:
                webhook = Webhook.from_url('url-here', session=session, platform=client.get_adapter('guilded'))
    ...
    async def fetch_message(self, message_id: str, /, *, channel: Optional[ChatChannel] = None, server: Optional[Server] = None) -> WebhookMessage:
        """|coro|
    ...
    async def delete_message(self, message_id: str, /, *, channel: Optional[ChatChannel] = None, server: Optional[Server] = None) -> None:
        """|coro|
